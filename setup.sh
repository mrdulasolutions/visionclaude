...
build_ios() {
    ...
    echo -e "     ${DIM}Xcode → ClaudeVision target → Signing & Capabilities → Team${RESET}"
    echo ""
    echo -e "  ${WHITE}3.${RESET} Connect your iPhone and build (⌘R)"
    echo ""
    echo -e "  ${WHITE}4.${RESET} Grant permissions when prompted:"
